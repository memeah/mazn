            ...
            <div class="add-client bg-white rounded">
                ...
                <div class="row p-20">
                    <div class="col-sm-12 col-md-6 col-lg-3">
                        <x-forms.select fieldName="colour" fieldId="colour" :fieldLabel="__('modules.sticky.colors')" onmousemove="calcVals()">
                            <option @if ($stickyNote->colour == '0.05') selected  @endif value="0.05">@lang('app.5%')
                            </option>
                            <option @if ($stickyNote->colour == '0.10') selected  @endif value="0.10">@lang('app.10%')
                            </option>
                            <option @if ($stickyNote->colour == '0.15') selected @endif  value="0.15">@lang('app.15%')
                            </option>
                            <option @if ($stickyNote->colour == '0.2') selected @endif  value="0.20">@lang('app.20%')
                            </option>
                    ...
                    <div class="col-lg-12">
                        <x-forms.textarea :fieldLabel="__('app.note')" fieldName="notetext" fieldId="notetext"
                            :fieldValue="$stickyNote->note_text" onmousemove="calcVals()"/>
                    </div>
                    <table width="100%">
                        <tr>
                            ...
                            <tr>
                                <td class="border-bottom-0 btrr-mbl btlr">
                                    <input name="tax" id="tax" type="text" :value="$stickyNotes->tax" html="true"  readonly >
