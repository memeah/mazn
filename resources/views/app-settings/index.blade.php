...
=======
                ...
                <div class="row">
                    <div class="col-sm-12 mt-lg-3" id="datatable">
                        <h4 class="f-16 font-weight-500 text-capitalize">
                            @lang('modules.projects.datatableRow')</h4>
                    </div>
                    <div class="col-lg-2 mb-5">
                        <x-forms.select fieldId="datatable_value"
                                    fieldName="datatable_value" search="true">
                            <option @if (global_setting()->no_of_row == 10)selected
                                @endif value = 10 >10</option>
                            <option @if (global_setting()->no_of_row == 20)selected
                                @endif value = 20 >20</option>
                            <option @if (global_setting()->no_of_row == 50)selected
                                @endif value = 50 >50</option>
                            <option @if (global_setting()->no_of_row == 100)selected
